...
class ExactGPModel(gpytorch.models.ExactGP):
    def __init__(self, train_x, train_y, likelihood, mean, ard_flag=False):
        ...
        self.covar_module = gpytorch.kernels.ScaleKernel(mean())
        if ard_flag:
            self.covar_module = gpytorch.kernels.ScaleKernel(mean(ard_num_dims=train_x.size(1)))
...
datasets = ['fertility2','concreteslump2','servo2','machine2','yacht2','housing2','energy2','concrete2','airfoil2']
#datasets = ['airfoil2']
rmses =[]
un_rmses =[]
nlls = []
